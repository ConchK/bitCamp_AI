...
# dense2= Dense(140, activation= 'sigmoid')(dense1)
...
model.fit(x_train, y_train, epochs=150, batch_size=10, validation_split=0.2, callbacks=[earlystopping, mcp], verbose=1)
