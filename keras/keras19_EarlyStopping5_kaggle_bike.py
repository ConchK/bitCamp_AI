...
hist=model.fit(x_train, y_train, epochs=300, batch_size=10, validation_split=0.2, callbacks=[earlystopping], verbose=1)
...
'''
loss : [22903.591796875, 110.88519287109375]
RMSE:  151.33932726275788
'''
...
submission.to_csv(path+ 'sampleSubmission_01091310.csv')  #제출용 파일 생성
