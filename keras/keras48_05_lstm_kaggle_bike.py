...
model= Sequential()
model.add(LSTM(units = 40, input_shape= (8,1), activation= 'relu'))
...
hist=model.fit(x_train, y_train, epochs=300, batch_size=20, validation_split=0.2, 
...
'''
dnn
loss : [24371.98828125, 114.83436584472656]
RMSE:  156.11532188115913
cnn
loss : [21974.208984375, 108.91911315917969]
RMSE:  148.23700232916593
lstm
loss : [24798.466796875, 117.43876647949219]
RMSE:  157.47529798993315
'''
