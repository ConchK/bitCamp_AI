...
conv1= Conv2D(filters=128, kernel_size=(2,2), input_shape=(32,32,3),
        padding= 'same', activation= 'relu')(input1)
maxpool1= MaxPooling2D()(conv1)
conv2= Conv2D(filters=64, kernel_size=(2,2), padding = 'same', strides=2)(maxpool1)
conv3= Conv2D(filters=64, kernel_size=(2,2), padding='same')(conv2)
