...
#2. 모델구성
model=Sequential()
model.add(Dense(400, input_dim=9))
model.add(Dense(320))
model.add(Dense(250))
model.add(Dense(180))
model.add(Dense(120))
...
hist=model.fit(x_train, y_train, epochs=500, batch_size=10, validation_split=0.2, callbacks=[earlystopping], verbose=1)
...
'''
loss : [2832.1025390625, 39.667205810546875]
RMSE:  53.21750184077272
...
# submission.to_csv(path+ 'submission_01062250.csv')  #제출용 파일 생성
