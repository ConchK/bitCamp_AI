...
model= Sequential()
model.add(Conv2D(60, (3,1), input_shape= (9,1,1), padding = 'same', activation= 'relu'))
model.add(Flatten())
model.add(Dense(80, activation= 'relu'))  
model.add(Dense(40,activation= 'relu'))
model.add(Dense(1, activation= 'linear'))
...
hist=model.fit(x_train, y_train, epochs=150, batch_size=10, validation_split=0.2, callbacks=[earlystopping], verbose=1)
...
'''
loss : [2250.984130859375, 35.27219009399414]
RMSE:  47.44453497127391
cnn
