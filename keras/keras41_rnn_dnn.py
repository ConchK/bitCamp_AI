...
# model.add(SimpleRNN(64, input_shape=(3,1), activation='relu'))   #[1,2,3]에서 하나식 연산 한다는 걸 명시해야 함 >연산량이 많아짐.
model.add(Dense(44, input_shape=(3,), activation= 'relu'))
...
dnn
loss :  [0.017937971279025078, 0.0]
[8,9,10]의 결과 :  [[11.323472]]
'''