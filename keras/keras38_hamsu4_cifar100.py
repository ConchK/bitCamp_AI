...
conv1= Conv2D(filters=128, kernel_size=(3,3), input_shape=(32,32,3),
        padding= 'same', activation= 'relu')(input1)
conv2= Conv2D(filters=64, kernel_size=(2,2), padding = 'same')(conv1)
maxpool1= MaxPooling2D()(conv2)
conv3= Conv2D(filters=64, kernel_size=(2,2))(maxpool1)
maxpool2= MaxPooling2D()(conv3)
