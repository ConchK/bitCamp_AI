...
model= Sequential()
model.add(LSTM(units = 40, input_shape=(32*32,3), activation= 'relu'))    #(31,31,128)
...
model.fit(x_train, y_train, epochs=100, verbose=2, batch_size=20, validation_split=0.2, callbacks=[earlystopping])
