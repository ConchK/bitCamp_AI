...
from tensorflow.keras.models import Sequential, Model, load_model  #인풋 레이어를 명시해야 함.
...
#모델 저장 안되고 가중치만 저장 됨. weights만 저장 되기 때문에 모델, 컴파일을 명시 해야 함. 
...
#모델 저장 안되고 가중치만 저장 됨. weights만 저장 되기 때문에 모델, 컴파일을 명시 해야 함. >> save_model 사용.
