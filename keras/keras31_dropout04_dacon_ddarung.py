...
dense3= Dense(120, activation= 'sigmoid')(drop1)
dense4= Dense(80, activation= 'relu')(dense3)
drop2= Dropout(0.5)(dense4)
...
hist=model.fit(x_train, y_train, epochs=150, batch_size=10, validation_split=0.2, callbacks=[earlystopping, mcp], verbose=1)
