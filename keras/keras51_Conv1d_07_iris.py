...
model= Sequential()
model.add(Conv1D(40, 2, input_shape= (2,2), padding= 'same', activation= 'relu'))
model.add(Conv1D(30, 2, padding= 'same', activation= 'relu'))
model.add(Flatten())
model.add(Dropout(0.5))
model.add(Dense(120, activation= 'relu'))  
model.add(Dense(60,activation= 'relu'))
model.add(Dense(3, activation= 'softmax'))  #다중분류는 무조건 softmax, loss='categorical_crossentropy'
model.summary()      
...
0.9
Conv1D
loss :  0.24337396025657654
accuracy :  0.8999999761581421
y_pred(예측값) :  [0 2 0 1 2 1 0 2 0 2 2 2 1 0 0 0 2 0 2 1 0 2 1 1 0 2 1 1 1 2]
y_test(원래값) :  [0 2 0 1 1 1 0 2 0 2 2 2 2 0 0 0 2 0 2 1 0 2 1 1 0 2 1 1 1 1]
0.9
'''