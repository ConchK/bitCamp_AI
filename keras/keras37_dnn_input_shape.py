...
from tensorflow. keras. layers import Conv2D, Dense, Flatten, MaxPooling2D, Dropout  # == Maxpool2D

model= Sequential()               # 3차원 x의 열을 그대로 넣어줌. 대신 flatten 사용.
...
model.add(Flatten())                 #reshape 하지 않고, 레이어에 Flatten을 넣어서 2차원으로 바꿔 진행.
