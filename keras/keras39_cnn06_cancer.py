...
model= Sequential()
model.add(Conv2D(40, (2,1), input_shape= (10,3,1), padding = 'same', activation= 'relu'))
...
model.fit(x_train, y_train, epochs=150, batch_size=10, validation_split=0.2, callbacks=[earlystopping], verbose=1)
